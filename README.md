...
HTML, CSS e JavaScript - As diferenças - (Gratuito, Português, Texto)
...
HTML para iniciantes: o que é e como funciona - (Gratuito, Português, Texto)
...
Introdução às tags HTML - (Gratuito, Inglês, Tutorial)
...
Tutorial de HTML Básico - MDN Web Docs (Gratuito, Português, Online)
...
Guia de referência rápida de HTML - HTML Dog (Gratuito, Inglês, Online)
...
Estrutura básica de uma página HTML - HTML Dog (Gratuito, Inglês, Online)
...
Tutorial de acessibilidade na web - WebAIM (Gratuito, Inglês, Online)
...
Modo Quirks e padrões em navegadores - MDN Web Docs (Gratuito, Inglês, Online)
...
Uso de extensões no Visual Studio Code - Visual Studio Code Docs (Gratuito, Inglês, Online)
...
Live Server Extension para Visual Studio Code - GitHub (Gratuito, Inglês, Online)
...
UX/UI Design: Fundamentos para a qualidade na interface de usuário - Interaction Design Foundation (Gratuito/Pago, Inglês, Online)
...
Dicas de CSS (Gratuito, Inglês, Online)
...
Guia de estruturação de páginas HTML com semântica - MDN Web Docs (Gratuito, Inglês, Online)
...
Utilizando Emmet para acelerar o desenvolvimento HTML - CSS-Tricks (Gratuito, Inglês, Online)
...
Introdução ao HTML5 e tags semânticas - HTML.com (Gratuito, Inglês, Online)
...
Uso efetivo de tags âncora em HTML - W3Schools (Gratuito, Inglês, Online)
...
Como inserir Imagens em HTML - MDN Web Docs (Gratuito, Inglês, Online)
...
Práticas recomendadas para design responsivo - Smashing Magazine (Gratuito, Inglês, Online)
...
Introdução ao CSS - W3Schools (Gratuito, Inglês, Online)
...
Como utilizar folhas de estilo em cascata (CSS) - MDN Web Docs (Gratuito, Inglês, Online)
...
Guia de cores e fontes em CSS - Adobe Color (Gratuito, Inglês, Online)
...
Hipsters ponto tech episódio #09 CSS: cansei de ser simples - (Gratuito, Português, Áudio)
